...
new SceneConstructor('forage','You find some fruits and feel relieved that you didn\'t have to hunt a boar. But is getting dark and you haven\'t find any signs of people on the island. You gather as much fruit as you can carrie and you hear a weird noise. Who is making this noise.','<ul> <li><button onclick = "renderPage(\'explore\')"> Follow the noise. </button></li> <li><button> Head back to shore. </button></li> <ul>','img/sunset.jpg');
