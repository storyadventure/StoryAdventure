...
new SceneConstructor('toolbox','Now that you have a toolbox you can fix the plane and get out of the island.','<ul> <li><button> button </button></li> </ul>', 'img/sunset.jpg');

new SceneConstructor('cryforhelp','You cried for help and the man has helped you. He carried you to the cabin where you wake up. He is a nice man that has been in the island for a long time. He is actually a mechanic and has agreed to help you to fix your plane.','<ul> <button> button </button></li> </ul>','img/sunset.jpg');

new SceneConstructor('fight','You fight him and barely made it out of the cabin. You have made a strong enemy.','<ul> <li><button> button </button></li> </ul>','img/sunset.jpg');
